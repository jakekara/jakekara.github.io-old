...
r.add(150);
r.add(50);
console.log("r looks like: " + r);
console.log("r is an instance of Ratchet: " + (r instanceof Ratchet));
console.log("r is an instance of Object: " + (r instanceof Object));
console.log("r is an instance of Ratchet.Node: " + (r instanceof Ratchet.Node));
// console.log("r is an instance of Bob: " + (r instanceof Bob));
